...
def parse_opts():
    ...
    parser.add_argument('--data_root', default='./data', type=str, help='Root directory path of data')
    ...
    parser.add_argument(
        '--pretrain_path', default='pretrain/resnet_50.pth', type=str, help='Path for pretrained model.'
    )
    parser.add_argument(
        '--new_layer_names',
        # default=['upsample1', 'cmp_layer3', 'upsample2', 'cmp_layer2', 'upsample3',
        #          'cmp_layer1', 'upsample4', 'cmp_conv1', 'conv_seg'],
        default=['conv_seg'],
        type=list,
    ...
    parser.add_argument(
        '--model', default='resnet', type=str, help='(resnet | preresnet | wideresnet | resnext | densenet | '
    )
    ...
    args.save_folder = f"./trails/models/{args.model}_{args.model_depth}"
